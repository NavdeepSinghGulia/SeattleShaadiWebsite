...
// Updated traditions with distinct Tamil and Telugu sections and SEO-friendly images
  ...
  hindu: [
    {
      ...
      imageUrl: '/images/ceremonies/haldi/indian-bride-haldi-ceremony.jpg',
    },
    {
      id: 'mehndi',
    ...
    },
    {
      ...
      imageUrl: '/images/celebrations/bollywood-wedding-dance.jpg',
    },
    {
      id: 'baraat',
      name: 'Baraat',
      ...
      imageUrl: '/images/ceremonies/baraat/colorful-baraat-wedding-procession.jpg',
    },
    {
      id: 'jaimala',
      ...
      imageUrl: '/images/portraits/bride-groom-wedding-portrait.jpg',
    },
    {
      id: 'pheras',
      ...
      imageUrl: '/images/portraits/bride-groom-wedding-ceremony.jpg',
    },
    {
      id: 'vidaai',
      name: 'Vidaai',
  ...
  sikh: [
    {
      ...
      imageUrl: '/images/celebrations/indian-wedding-dance-celebration.png',
    },
    {
      id: 'anand-karaj',
      name: 'Anand Karaj',
  ...
  tamil: [
    {
      ...
      imageUrl: '/images/portraits/kaajol-pruthul-wedding-portrait.jpg',
    },
    {
      id: 'kanyadaanam',
      name: 'Kanyadaanam',
  ...
  telugu: [
    {
      ...
      imageUrl: '/images/portraits/bride-groom-wedding-decor.jpg',
    },
    {
...
const TraditionsPage = () => {
  ...
  return (
    <>
      <Seo
        title="Indian Wedding Traditions & Customs | Hindu, Sikh, Tamil, Telugu, Muslim"
        description="Explore Indian wedding traditions across Hindu, Sikh, Tamil, Telugu, and Muslim cultures. Discover Jago, Oonjal, Talambralu, Laavan, Pheras & more with modern adaptations."
        keywords="Indian wedding traditions, Sikh Jago, Tamil Oonjal, Telugu Talambralu, Hindu pheras, Muslim Nikah, Seattle Indian wedding rituals"
      />
