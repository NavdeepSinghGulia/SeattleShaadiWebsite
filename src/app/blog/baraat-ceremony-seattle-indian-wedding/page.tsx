            ...
            <AnimatedDiv delay={700} animation="fadeInScale">
                <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-foreground/90">
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/traditional-baraat-procession-celebration.jpg" alt="Traditional Baraat procession" data-ai-hint="baraat procession" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/colorful-baraat-wedding-procession.jpg" alt="Colorful Baraat celebration" data-ai-hint="baraat celebration" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/bride-groom-ceremony-handshake.jpg" alt="Family meeting ceremony" data-ai-hint="family meeting ceremony" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/traditional-wedding-dance.jpg" alt="Traditional wedding dance" data-ai-hint="wedding dance celebration" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
