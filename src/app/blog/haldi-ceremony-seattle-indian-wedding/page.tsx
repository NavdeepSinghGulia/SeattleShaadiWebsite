            ...
            <AnimatedDiv delay={700} animation="fadeInScale">
                <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-foreground/90">
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/indian-bride-haldi-ceremony.jpg" alt="Bride during Haldi ceremony" data-ai-hint="bride haldi ceremony" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/charlotte-mehndi-ceremony-bride.jpg" alt="Traditional Indian wedding preparation" data-ai-hint="indian wedding preparation" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/intricate-mehndi-henna-designs.jpg" alt="Indian wedding celebration" data-ai-hint="indian wedding celebration" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
