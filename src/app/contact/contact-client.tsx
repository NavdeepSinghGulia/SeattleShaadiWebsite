                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <a href="tel:+12068216764" className="text-muted-foreground hover:text-primary transition-colors" onClick={() => trackEvent('contact_click', 'engagement', 'phone')}>
                        +1 (206) 821-6764
                      </a>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@seattleshaadi.com" className="text-muted-foreground hover:text-primary transition-colors" onClick={() => trackEvent('contact_click', 'engagement', 'email')}>
