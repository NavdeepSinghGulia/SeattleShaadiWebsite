            ...
            <AnimatedDiv delay={700} animation="fadeInScale">
                <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-foreground/90">
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/charlotte-mehndi-ceremony-bride.jpg" alt="Beautiful Mehndi ceremony celebration" data-ai-hint="mehndi ceremony celebration" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/intricate-mehndi-henna-designs.jpg" alt="Intricate Mehndi designs" data-ai-hint="mehndi henna designs" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/bride-dance-celebration.jpeg" alt="Bride celebrating at Mehndi ceremony" data-ai-hint="bride mehndi celebration" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
                    ...
                    <div className="relative w-full aspect-video rounded-lg overflow-hidden my-6">
                        <Image src="/indian-wedding-food-menu-spread.jpg" alt="Indian wedding food spread" data-ai-hint="indian wedding food" fill style={{ objectFit: 'cover' }} sizes="(max-width: 768px) 100vw, 896px" loading="lazy"/>
                    </div>
